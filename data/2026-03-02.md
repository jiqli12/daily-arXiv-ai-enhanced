...
### [121] [Lifecycle-Integrated Security for AI-Cloud Convergence in Cyber-Physical Infrastructure](https://arxiv.org/abs/2602.23397)
...
### [122] [Learning to Generate Secure Code via Token-Level Rewards](https://arxiv.org/abs/2602.23407)
...
### [124] [Lap2: Revisiting Laplace DP-SGD for High Dimensions via Majorization Theory](https://arxiv.org/abs/2602.23516)
...
### [125] [I've Seen This IP: A Practical Intersection Attack Against Tor Introduction Circuits and Hidden Services](https://arxiv.org/abs/2602.23560)
...
### [126] [CLOAQ: Combined Logic and Angle Obfuscation for Quantum Circuits](https://arxiv.org/abs/2602.23569)
...
### [127] [PDF: PUF-based DNN Fingerprinting for Knowledge Distillation Traceability](https://arxiv.org/abs/2602.23587)
...
### [128] [Central Bank Digital Currencies: Where is the Privacy, Technology, and Anonymity?](https://arxiv.org/abs/2602.23659)
...
### [129] [Privacy-Preserving Local Energy Trading Considering Network Fees](https://arxiv.org/abs/2602.23698)
...
### [130] [PLA for Drone RID Frames via Motion Estimation and Consistency Verification](https://arxiv.org/abs/2602.23760)
...
### [131] [Tilewise Domain-Separated Selective Encryption for Remote Sensing Imagery under Chosen-Plaintext Attacks](https://arxiv.org/abs/2602.23772)
...
### [132] [Enhancing Continual Learning for Software Vulnerability Prediction: Addressing Catastrophic Forgetting via Hybrid-Confidence-Aware Selective Replay for Temporal LLM Fine-Tuning](https://arxiv.org/abs/2602.23834)
...
### [133] [MI$^2$DAS: A Multi-Layer Intrusion Detection Framework with Incremental Learning for Securing Industrial IoT Networks](https://arxiv.org/abs/2602.23846)
...
### [134] [Exploring Robust Intrusion Detection: A Benchmark Study of Feature Transferability in IoT Botnet Attack Detection](https://arxiv.org/abs/2602.23874)
...
### [135] [Jailbreak Foundry: From Papers to Runnable Attacks for Reproducible Benchmarking](https://arxiv.org/abs/2602.24009)
...
### [136] [SAILOR: A Scalable and Energy-Efficient Ultra-Lightweight RISC-V for IoT Security](https://arxiv.org/abs/2602.24166)
...
### [137] [Anansi: Scalable Characterization of Message-Based Job Scams](https://arxiv.org/abs/2602.24223)
...
### [138] [HumanMCP: A Human-Like Query Dataset for Evaluating MCP Tool Retrieval Performance](https://arxiv.org/abs/2602.23367)
...
### [139] [An Agentic LLM Framework for Adverse Media Screening in AML Compliance](https://arxiv.org/abs/2602.23373)
...
### [140] [Causal Identification from Counterfactual Data: Completeness and Bounding Results](https://arxiv.org/abs/2602.23541)
...
### [141] [Planning under Distribution Shifts with Causal POMDPs](https://arxiv.org/abs/2602.23545)
...
### [142] [Construct, Merge, Solve & Adapt with Reinforcement Learning for the min-max Multiple Traveling Salesman Problem](https://arxiv.org/abs/2602.23579)
...
### [143] [SleepLM: Natural-Language Intelligence for Human Sleep](https://arxiv.org/abs/2602.23605)
...
### [144] [MMKG-RDS: Reasoning Data Synthesis via Deep Mining of Multimodal Knowledge Graphs](https://arxiv.org/abs/2602.23632)
...
### [145] [AI Must Embrace Specialization via Superhuman Adaptable Intelligence](https://arxiv.org/abs/2602.23643)
...
### [146] [PseudoAct: Leveraging Pseudocode Synthesis for Flexible Planning and Action Control in Large Language Model Agents](https://arxiv.org/abs/2602.23668)
*Yihan,Wen,Xin Chen*
...
### [147] [ODAR: Principled Adaptive Routing for LLM Reasoning via Active Inference](https://arxiv.org/abs/2602.23681)
...
### [148] [From Flat Logs to Causal Graphs: Hierarchical Failure Attribution for LLM-based Multi-Agent Systems](https://arxiv.org/abs/2602.23701)
...
### [149] [ProductResearch: Training E-Commerce Deep Research Agents via Multi-Agent Synthetic Trajectory Distillation](https://arxiv.org/abs/2602.23716)
...
### [150] [The Auton Agentic AI Framework](https://arxiv.org/abs/2602.23720)
...
### [151] [Unlocking Cognitive Capabilities and Analyzing the Perception-Logic Trade-off](https://arxiv.org/abs/2602.23730)
...
### [152] [Reasoning-Driven Multimodal LLM for Domain Generalization](https://arxiv.org/abs/2602.23777)
...
### [153] [EMO-R3: Reflective Reinforcement Learning for Emotional Reasoning in Multimodal Large Language Models](https://arxiv.org/abs/2602.23802)
...
### [154] [RF-Agent: Automated Reward Function Design via Language Agent Tree Search](https://arxiv.org/abs/2602.23876)
...
### [155] [Pessimistic Auxiliary Policy for Offline Reinforcement Learning](https://arxiv.org/abs/2602.23974)
...
### [156] [Portfolio Reinforcement Learning with Scenario-Context Rollout](https://arxiv.org/abs/2602.24037)
...
### [157] [CIRCLE: A Framework for Evaluating AI from a Real-World Lens](https://arxiv.org/abs/2602.24055)
...
### [158] [Human or Machine? A Preliminary Turing Test for Speech-to-Speech Interaction](https://arxiv.org/abs/2602.24080)
...
### [159] [Bi-level RL-Heuristic Optimization for Real-world Winter Road Maintenance](https://arxiv.org/abs/2602.24097)
...
### [160] [Artificial Agency Program: Curiosity, compression, and communication in agents](https://arxiv.org/abs/2602.24100)
*Richard Csaky*
...
### [161] [Recycling Failures: Salvaging Exploration in RLVR via Fine-Grained Off-Policy Guidance](https://arxiv.org/abs/2602.24110)
...
### [162] [LemmaBench: A Live, Research-Level Benchmark to Evaluate LLM Capabilities in Mathematics](https://arxiv.org/abs/2602.24173)
...
### [163] [Uncertainty Quantification for Multimodal Large Language Models with Incoherence-adjusted Semantic Volume](https://arxiv.org/abs/2602.24195)
...
### [164] [A Minimal Agent for Automated Theorem Proving](https://arxiv.org/abs/2602.24273)
...
### [165] [DARE-bench: Evaluating Modeling and Instruction Fidelity of LLMs in Data Science](https://arxiv.org/abs/2602.24288)
...
### [166] [Optimization of Edge Directions and Weights for Mixed Guidance Graphs in Lifelong Multi-Agent Path Finding](https://arxiv.org/abs/2602.23468)
...
### [167] [A Novel Hierarchical Multi-Agent System for Payments Using LLMs](https://arxiv.org/abs/2602.24068)
...
### [168] [Sharing is caring: data sharing in multi-agent supply chains](https://arxiv.org/abs/2602.24074)
...
### [169] [QD-MAPPER: A Quality Diversity Framework to Automatically Evaluate Multi-Agent Path Finding Algorithms in Diverse Maps](https://arxiv.org/abs/2409.06888)
