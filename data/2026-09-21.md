...
### [140] [The Right Tool for the Job: On the Selection of Mitigations for GenAI Privacy Threats](https://arxiv.org/abs/2609.20884)
...
### [141] [Loopjacking: Hijacking Human-in-the-Loop Approval](https://arxiv.org/abs/2609.21081)
*Adithyan Arun Kumar*
...
### [142] [TPM-Attest: Hardware-Rooted Integrity Attestation as a Kernel-Level Anti-Cheat Alternative for Linux](https://arxiv.org/abs/2609.20909)
...
### [143] [(Don't) Trust, but (Don't) Verify: Developers' Attention to Security in AI-Generated Code](https://arxiv.org/abs/2609.21020)
...
### [144] [Origin Is All You Need: Provenance-Aware Transformers for Structural Trust-Boundary Separation](https://arxiv.org/abs/2609.21088)
...
### [145] [NetInspector: Measuring and Improving LLM Capabilities for Reliable Intent-Based Networking Policy Generation](https://arxiv.org/abs/2609.21103)
...
### [146] [Toss If Perishable: An Ethnographic Study on Building Scenario-Based Training for Non-Perishable Skills](https://arxiv.org/abs/2609.21147)
...
### [147] [X-SPUR: Explainable Surprisal-Based Protocol-Aware Unsupervised Reasoning for Automotive Ethernet Intrusion Detection](https://arxiv.org/abs/2609.21217)
...
### [148] [Combining Exploratory Analysis and Automated Analysis for Anomaly Detection in Real-Time Data Streams](https://arxiv.org/abs/2609.21222)
...
### [149] [Transcript-Bound Combiners for Downgrade-Resilient Hybrid Post-Quantum Key Establishment: Definition, Proof, and Embedded-Device Cost](https://arxiv.org/abs/2609.21273)
...
### [150] [Identifying Security Platform Product Abuse with Machine Learning](https://arxiv.org/abs/2609.21303)
...
### [151] [Conformal Privacy Auditing: Calibrated Re-identification Attacks with Statistical Guarantees](https://arxiv.org/abs/2609.21340)
...
### [152] [CESBench: Benchmarking Large Language Models on Cryptographic Engineering Security for IoT Devices](https://arxiv.org/abs/2609.21344)
...
### [153] [Batched Paillier-Based Hamming-Distance Computation over Binary Embeddings](https://arxiv.org/abs/2609.21364)
...
### [154] [TrustBOM: A Scalable Architecture for Confidentiality-Preserving SBOMs Across Organizations](https://arxiv.org/abs/2609.21419)
...
### [155] [DEFEAT: Stitching Fragmented File I/O Contexts for Early Ransomware Detection](https://arxiv.org/abs/2609.21426)
...
### [156] [HE-Guardrail: A Homomorphic Guardrail Against Jailbreak Attacks for Encrypted Large Language Model Inference](https://arxiv.org/abs/2609.21484)
...
### [157] [ServeGuard: Verifiable, Bounded-Residual Confinement of Operator-Invisible Channels Without Revealing the Certified Read Factor](https://arxiv.org/abs/2609.21515)
...
### [158] [Critical sets of Latin squares based on autoparatopisms](https://arxiv.org/abs/2609.21532)
...
### [159] [Et Tu, MacBook? Unprivileged Keystroke Inference and Context Profiling via the Built-in IMU Side Channel](https://arxiv.org/abs/2609.21569)
...
### [160] [Micro-Collaborative Poisoning: A Distributed Attack on RAG Systems](https://arxiv.org/abs/2609.21573)
...
### [161] [CIPL: A Channel-Aware Framework for Recoverable Privacy Leakage in LLM Agents](https://arxiv.org/abs/2609.21686)
...
### [162] [TERMon: Detecting Persistent Behavioral Threats in Edge AI via Hardware-Native Ternary Runtime Monitor](https://arxiv.org/abs/2609.21713)
...
### [163] [A Framework to Quantify the Probability of Future Cyber Loss Events](https://arxiv.org/abs/2609.21717)
...
### [164] [Verifiable Computation with Trusted Execution Environments and On-Chain Digital Rights Tokens](https://arxiv.org/abs/2609.21728)
...
### [165] [CASCADE Against Jailbreaks: Combination Across Stages with Controlled Attack-Defense Evaluation](https://arxiv.org/abs/2609.21793)
*Jiale Luo,Eric Han*
...
### [166] [Watermarkable Multi-Draft Speculative Sampling via Poisson Processes](https://arxiv.org/abs/2609.21858)
...
### [167] [SFPF: Spatio-Frequency Polarization Fingerprint for Anomalous Wireless Device Detection](https://arxiv.org/abs/2609.21873)
...
### [168] [End-to-End Hard-Label Cryptanalytic Model Extraction Using Efficient Sign Recovery](https://arxiv.org/abs/2609.21941)
...
### [169] [Provisional Reachability: Containing Agents by Making Every Crossing Revocable](https://arxiv.org/abs/2609.21957)
*Yoshiaki Takashita*
...
### [170] [The Supersingular Isogeny Problem in Time and Memory $p^{1/3+o(1)}$, Unconditionally](https://arxiv.org/abs/2609.22018)
*José Luis Delgado*
...
### [171] [APort Vault: Benchmarking AI Agent Payment Authorization with the Open Agent Passport](https://arxiv.org/abs/2609.22076)
*Uchi Uchibeke*
...
### [172] [BirdsongChat: A Hybrid Multi-Agent Framework for Multimodal Embodied Behavior Simulation](https://arxiv.org/abs/2609.20887)
...
### [173] [Proxifield: Decentralized Multi-Agent Communication through Semantic Proximity](https://arxiv.org/abs/2609.20889)
...
### [174] [CityLearn v3: A Configurable Simulation and Evaluation Framework for Realistic Control Studies of Renewable Energy Communities](https://arxiv.org/abs/2609.21570)
...
### [175] [Bayesian Belief Layer for Controllable Opinion Dynamics in LLM Agents](https://arxiv.org/abs/2609.21997)
...
### [179] [CaLR: Causal Latent Revision for Robust Diffusion Reasoning](https://arxiv.org/abs/2609.20981)
...
### [180] [LoRA Enhanced Contrastive Learning with SAS Vision Transformers](https://arxiv.org/abs/2609.21061)
...
### [181] [Detecting Hallucination in LLMs: Tracing the Topological Signatures of Impaired Context Sharing](https://arxiv.org/abs/2609.21096)
...
### [182] [Decoupling Internal Representational Changes and Causal Importance in Fine-Tuned Large Language Models](https://arxiv.org/abs/2609.21113)
...
### [183] [TinyCeNN-LM: Quality-Gated Conversion of Pretrained Attention with CeNN-Inspired Cellular-Recurrent Layers](https://arxiv.org/abs/2609.21139)
...
### [184] [Clinician-Grounded Quality Assurance for AI-Assisted Psychiatric Intake](https://arxiv.org/abs/2609.21149)
...
### [185] [Can Agents Design Better Chips with a Higher Level Abstraction?](https://arxiv.org/abs/2609.21157)
...
### [186] [SpecOpt: Contact-Diff Reasoning for Agentic Molecule Optimization Toward Binding Specificity](https://arxiv.org/abs/2609.21165)
*Thao Nguyen,Heng Ji*
...
### [187] [Implicit Rule Induction with Test-Time Task Embeddings in ARC-like Tasks](https://arxiv.org/abs/2609.21181)
