...
TL;DR: 本文提出了一种用于实时路边交通违规分析的边缘AI感知节点，在NVIDIA Jetson Nano上实现高精度多类别违规检测和车牌识别，并通过V2X协议发布安全事件。


<details>
  <summary>Details</summary>
Motivation: 印度等新兴经济体的快速机动化导致执法严重不对称，2023年记录违规超过1100万起，而警力密度仅为每4000辆车一名警官。传统监控和人工罚单无法应对这种规模，需要自主、协作且节能的边缘AI感知基础设施。

Method: 系统整合YOLOv8 Nano进行高精度多目标检测，DeepSORT实现时间一致的车辆跟踪，以及基于规则的OCR后处理引擎识别符合标准的车牌。部署在NVIDIA Jetson Nano上，通过TensorRT FP16量化优化，无需手动校准感兴趣区域。

Result: 系统在9.6W功耗下维持28-30FPS推理，实现97.7%的违规检测准确率和84.9%的OCR精度，涵盖信号灯闯行、斑马线违规、逆行、非法掉头和超速五类违规。相比其他模型获得10.7%的平均精度提升和1.4倍的能效比改进。

Conclusion: 路边边缘AI分析可以增强协作感知和主动道路安全管理，通过V2X协议向联网车辆和智能交通系统后端发布标准化的CAM和DENM类型安全事件，在IEEE智能车辆生态系统中具有重要应用价值。
...
TL;DR: 该论文提出了ROAD基准测试，用于评估LiDAR点云分类在同时面临域偏移和标签演化时的鲁棒性，填补了3D感知在持续学习和迁移学习方面的研究空白。


<details>
  <summary>Details</summary>
Motivation: 3D感知系统在实际应用中需要适应不断变化的对象定义和传感器域，但3D点云感知在持续学习和迁移学习方面的研究相对不足，特别是在同时面临域偏移和标签演化的情况下。

Method: 提出了ROAD基准测试，专门针对LiDAR点云分类，考虑了域偏移以及三种标签演化形式：类别分割、类别扩展和类别插入。使用大规模数据集（Waymo、NuScenes、Argoverse2）评估零样本迁移、线性探测和持续学习方法。

Result: 评估发现现有方法在现实偏移下存在局限性，为未来鲁棒3D感知研究建立了强基线。分析了主干架构、训练目标和持续学习方法的影响。

Conclusion: ROAD基准测试填补了3D点云感知在持续学习和迁移学习方面的研究空白，揭示了现有方法在现实域偏移和标签演化下的局限性，为未来鲁棒3D感知研究提供了重要基础。
...
<details>
  <summary>Details</summary>
Motivation: 2D拖拽编辑已取得显著进展，但3D场景的直观拖拽编辑仍然具有挑战性。现有3D编辑方法在几何相关内容编辑方面存在局限，需要一种能弥合变形基和2D编辑基方法差距的解决方案

Method: 1. 利用3D高斯泼溅进行变形引导，实现一致的几何修改；2. 使用扩散引导进行内容校正和视觉质量增强；3. 采用渐进式编辑策略支持激进的3D拖拽编辑

Result: 方法支持多种编辑类型（运动变化、形状调整、修复、内容扩展），在各种场景中表现出色，在几何相关的3D内容编辑方面达到最先进性能，编辑效率高（单RTX 4090 GPU上10-20分钟）

Conclusion: 3DGS-Drag提供了一个高效直观的3D编辑框架，成功弥合了变形基和2D编辑基方法之间的差距，为3D内容创作开辟了新可能性
...
TL;DR: 本文提出了一个开源芝麻植物分割数据集，包含292张图像（206训练/43验证/43测试），采用像素级分割标注，支持农业AI模型开发，在YOLOv8框架下取得了良好的检测和分割性能。


<details>
  <summary>Details</summary>
Motivation: 为农业应用特别是芝麻植物的AI模型开发提供专门的数据集支持，弥补传统边界框数据集在精确检测和分析方面的不足，促进植物监测、产量估算等农业研究。

Method: 使用高分辨率移动相机在尼日利亚卡齐纳州农场采集芝麻早期生长阶段图像，采用Segment Anything Model version 2在农民监督下进行像素级分割标注，构建YOLO兼容格式数据集。

Result: 使用Ultralytics YOLOv8框架评估：边界框检测召回率79%、精确率79%、mAP@0.5为84%、mAP@0.5:0.95为58%；分割任务召回率82%、精确率77%、mAP@0.5为84%、mAP@0.5:0.95为52%。

Conclusion: 该数据集是尼日利亚首个专注于芝麻的农业视觉数据集，支持精确的植物检测和分析，为植物监测、产量估算等农业应用提供了有价值的资源。
...
### [18] [SafeRedir: Prompt Embedding Redirection for Robust Unlearning in Image Generation Models](https://arxiv.org/abs/2601.08623)
...
### [32] [Route, Retrieve, Reflect, Repair: Self-Improving Agentic Framework for Visual Detection and Linguistic Reasoning in Medical Imaging](https://arxiv.org/abs/2601.08192)
...
### [38] [AIMC-Spec: A Benchmark Dataset for Automatic Intrapulse Modulation Classification under Variable Noise Conditions](https://arxiv.org/abs/2601.08265)
...
### [40] [One-Shot Identification with Different Neural Network Approaches](https://arxiv.org/abs/2601.08278)
...
### [41] [KidVis: Do Multimodal Large Language Models Possess the Visual Perceptual Capabilities of a 6-Year-Old?](https://arxiv.org/abs/2601.08292)
...
### [42] [M3SR: Multi-Scale Multi-Perceptual Mamba for Efficient Spectral Reconstruction](https://arxiv.org/abs/2601.08293)
...
### [43] [ReCo-KD: Region- and Context-Aware Knowledge Distillation for Efficient 3D Medical Image Segmentation](https://arxiv.org/abs/2601.08301)
...
### [44] [SnapGen++: Unleashing Diffusion Transformers for Efficient High-Fidelity Image Generation on Edge Devices](https://arxiv.org/abs/2601.08303)
...
### [45] [Enhancing Image Quality Assessment Ability of LMMs via Retrieval-Augmented Generation](https://arxiv.org/abs/2601.08311)
...
### [46] [YOLOBirDrone: Dataset for Bird vs Drone Detection and Classification and a YOLO based enhanced learning architecture](https://arxiv.org/abs/2601.08319)
...
### [47] [UM-Text: A Unified Multimodal Model for Image Understanding](https://arxiv.org/abs/2601.08321)
...
### [48] [IGAN: A New Inception-based Model for Stable and High-Fidelity Image Synthesis Using Generative Adversarial Networks](https://arxiv.org/abs/2601.08332)
...
### [49] [Tissue Classification and Whole-Slide Images Analysis via Modeling of the Tumor Microenvironment and Biological Pathways](https://arxiv.org/abs/2601.08336)
...
### [50] [From Local Windows to Adaptive Candidates via Individualized Exploratory: Rethinking Attention for Image Super-Resolution](https://arxiv.org/abs/2601.08341)
...
### [51] [Semantic Misalignment in Vision-Language Models under Perceptual Degradation](https://arxiv.org/abs/2601.08355)
*Guo Cheng*
...
### [52] [Geo-NVS-w: Geometry-Aware Novel View Synthesis In-the-Wild with an SDF Renderer](https://arxiv.org/abs/2601.08371)
...
### [53] [Source-Free Domain Adaptation for Geospatial Point Cloud Semantic Segmentation](https://arxiv.org/abs/2601.08375)
...
### [54] [An Explainable Two Stage Deep Learning Framework for Pericoronitis Assessment in Panoramic Radiographs Using YOLOv8 and ResNet-50](https://arxiv.org/abs/2601.08401)
...
### [55] [Edge-Optimized Multimodal Learning for UAV Video Understanding via BLIP-2](https://arxiv.org/abs/2601.08408)
...
### [56] [SPARK: Scalable Real-Time Point Cloud Aggregation with Multi-View Self-Calibration](https://arxiv.org/abs/2601.08414)
*Chentian Sun*
...
### [57] [MMLGNet: Cross-Modal Alignment of Remote Sensing Data using CLIP](https://arxiv.org/abs/2601.08420)
...
### [58] [Deep Learning Based Facial Retargeting Using Local Patches](https://arxiv.org/abs/2601.08429)
...
### [59] [Incentivizing Cardiologist-Like Reasoning in MLLMs for Interpretable Echocardiographic Diagnosis](https://arxiv.org/abs/2601.08440)
...
### [60] [Noise-Adaptive Regularization for Robust Multi-Label Remote Sensing Image Classification](https://arxiv.org/abs/2601.08446)
...
### [61] [Divide and Conquer: Static-Dynamic Collaboration for Few-Shot Class-Incremental Learning](https://arxiv.org/abs/2601.08448)
...
### [62] [Developing Predictive and Robust Radiomics Models for Chemotherapy Response in High-Grade Serous Ovarian Carcinoma](https://arxiv.org/abs/2601.08455)
...
### [63] [Modality-Decoupled RGB-Thermal Object Detector via Query Fusion](https://arxiv.org/abs/2601.08458)
...
### [64] [CoMa: Contextual Massing Generation with Vision-Language Models](https://arxiv.org/abs/2601.08464)
...
### [65] [Zero-Shot Distracted Driver Detection via Vision Language Models with Double Decoupling](https://arxiv.org/abs/2601.08467)
...
### [66] [Towards Safer Mobile Agents: Scalable Generation and Evaluation of Diverse Scenarios for VLMs](https://arxiv.org/abs/2601.08470)
...
### [67] [Cross-modal Proxy Evolving for OOD Detection with Vision-Language Models](https://arxiv.org/abs/2601.08476)
...
### [68] [An IoT-Enabled Smart Aquarium System for Real-Time Water Quality Monitoring and Automated Feeding](https://arxiv.org/abs/2601.08484)
...
### [69] [PKI: Prior Knowledge-Infused Neural Network for Few-Shot Class-Incremental Learning](https://arxiv.org/abs/2601.08493)
...
### [70] [EfficientFSL: Enhancing Few-Shot Classification via Query-Only Tuning in Vision Transformers](https://arxiv.org/abs/2601.08499)
...
### [71] [Closed-Loop LLM Discovery of Non-Standard Channel Priors in Vision Models](https://arxiv.org/abs/2601.08517)
...
### [72] [CD^2: Constrained Dataset Distillation for Few-Shot Class-Incremental Learning](https://arxiv.org/abs/2601.08519)
...
### [73] [VideoHEDGE: Entropy-Based Hallucination Detection for Video-VLMs via Semantic Clustering and Spatiotemporal Perturbations](https://arxiv.org/abs/2601.08557)
...
### [74] [REVNET: Rotation-Equivariant Point Cloud Completion via Vector Neuron Anchor Transformer](https://arxiv.org/abs/2601.08558)
...
### [75] [End-to-End Video Character Replacement without Structural Guidance](https://arxiv.org/abs/2601.08587)
...
### [76] [WaveFormer: Frequency-Time Decoupled Vision Modeling with Wave Equation](https://arxiv.org/abs/2601.08602)
...
### [77] [Interpretability and Individuality in Knee MRI: Patient-Specific Radiomic Fingerprint with Reconstructed Healthy Personas](https://arxiv.org/abs/2601.08604)
...
### [78] [SfMamba: Efficient Source-Free Domain Adaptation via Selective Scan Modeling](https://arxiv.org/abs/2601.08608)
...
### [79] [SoC: Semantic Orthogonal Calibration for Test-Time Prompt Tuning](https://arxiv.org/abs/2601.08617)
...
### [80] [CtrlFuse: Mask-Prompt Guided Controllable Infrared and Visible Image Fusion](https://arxiv.org/abs/2601.08619)
...
### [81] [Além do Desempenho: Um Estudo da Confiabilidade de Detectores de Deepfakes](https://arxiv.org/abs/2601.08674)
...
### [82] [Salience-SGG: Enhancing Unbiased Scene Graph Generation with Iterative Salience Estimation](https://arxiv.org/abs/2601.08728)
...
### [83] [ISLA: A U-Net for MRI-based acute ischemic stroke lesion segmentation with deep supervision, attention, domain adaptation, and ensemble learning](https://arxiv.org/abs/2601.08732)
...
### [84] [UR-Bench: A Benchmark for Multi-Hop Reasoning over Ultra-High-Resolution Images](https://arxiv.org/abs/2601.08748)
...
### [85] [Translating Light-Sheet Microscopy Images to Virtual H&E Using CycleGAN](https://arxiv.org/abs/2601.08776)
*Yanhua Zhao*
...
### [86] [Aggregating Diverse Cue Experts for AI-Generated Image Detection](https://arxiv.org/abs/2601.08790)
...
### [87] [DentalX: Context-Aware Dental Disease Detection with Radiographs](https://arxiv.org/abs/2601.08797)
...
### [88] [Near-perfect photo-ID of the Hula painted frog with zero-shot deep local-feature matching](https://arxiv.org/abs/2601.08798)
...
### [89] [S3-CLIP: Video Super Resolution for Person-ReID](https://arxiv.org/abs/2601.08807)
...
### [90] [Reasoning Matters for 3D Visual Grounding](https://arxiv.org/abs/2601.08811)
...
### [92] [3AM: Segment Anything with Geometric Consistency in Videos](https://arxiv.org/abs/2601.08831)
...
### [93] [RAVEN: Erasing Invisible Watermarks via Novel View Synthesis](https://arxiv.org/abs/2601.08832)
...
<details>
  <summary>Details</summary>
Motivation: 大语言模型在创意生成方面存在困难，而多智能体框架虽然能提升推理能力，但会通过内容同质化抑制创造力，需要解决这一矛盾。

Method: 提出LLM Review框架，采用盲审机制：智能体交换针对性反馈但独立修改，保持创意轨迹的多样性。同时构建SciFi-100科幻写作数据集，结合LLM评分、人工标注和基于规则的新颖性指标进行综合评估。

Result: 实验表明LLM Review在多智能体基线方法中表现最优，小模型配合该框架可以超越更大的单智能体模型，表明交互结构可以替代模型规模。

Conclusion: LLM Review框架通过盲审机制有效解决了多智能体协作中的创意同质化问题，为提升LLM的创意生成能力提供了新思路，交互结构设计可以弥补模型规模的不足。
...
### [95] [A Human-Centric Pipeline for Aligning Large Language Models with Chinese Medical Ethics](https://arxiv.org/abs/2601.07954)
...
Method: 1) 构建MedES基准：从260个权威中文医疗、伦理和法律来源创建动态、场景中心的基准；2) 提出监护人循环框架：利用自动化评估器（在领域内准确率超过97%）生成针对性提示和结构化伦理反馈；3) 通过监督微调和领域特定偏好优化对齐7B参数LLM。

Result: 在中文医疗伦理背景下，对齐后的模型在核心伦理任务上显著优于更大的基线模型，在质量和综合评估指标上都有明显提升。

Conclusion: 该工作为中文医疗领域对齐LLM与医疗伦理提供了实用且可适应的框架，并表明通过模块化替换底层规范语料，类似的对齐流程可以在其他法律和文化环境中实例化。
...
### [96] [Knowing But Not Doing: Convergent Morality and Divergent Action in LLMs](https://arxiv.org/abs/2601.07972)
*Jen-tse Huang,Jiantong Qin,Xueli Qiu,Sharon Levy,Michelle R. Kaufman,Mark Dredze*

Main category: cs.CL

TL;DR: 研究评估了10个前沿大语言模型在价值对齐方面的表现，发现模型间决策高度一致但与人类差异显著，且模型和人类都存在价值认知与行动之间的差距。


<details>
  <summary>Details</summary>
Motivation: 价值对齐对开发安全、社会兼容的人工智能至关重要，但大语言模型如何在现实决策情境中表征和执行人类价值观仍缺乏深入探索。

Method: 创建ValAct-15k数据集（包含3000个基于Reddit的求助场景），基于Schwartz基本人类价值理论评估10个前沿LLM（5个美国公司，5个中国公司）和55名人类参与者，使用场景问题和传统价值观问卷进行对比分析。

Result: 模型间场景决策一致性接近完美（Pearson r≈1.0），而人类间差异显著（r∈[-0.79,0.98]）；人类和模型都表现出自我报告价值观与实际行动之间的弱相关性（r=0.4,0.3）；当被要求"持有"特定价值观时，模型性能下降达6.6%。

Conclusion: 对齐训练虽然能产生规范性的价值趋同，但无法消除人类特有的价值认知与行动之间的不一致性，模型表现出类似人类的角色扮演厌恶。
...
### [97] [Explaining Generalization of AI-Generated Text Detectors Through Linguistic Analysis](https://arxiv.org/abs/2601.07974)
*Yuxi Xia,Kinga Stańczak,Benjamin Roth*

Main category: cs.CL

TL;DR: AI文本检测器在跨提示、跨模型、跨领域泛化中存在性能差异，本文通过系统性的语言特征分析揭示了泛化性能与特定语言特征（如时态使用和代词频率）之间的关联。
...
Method: 构建了一个包含6种提示策略、7个大语言模型和4个领域数据集的综合基准，生成了多样的人类和AI生成文本。在不同生成设置上微调基于分类的检测器，并评估其跨提示、跨模型和跨数据集的泛化能力。通过计算80个语言特征在训练和测试条件之间的特征偏移与泛化准确率的相关性来解释性能差异。

Result: 分析表明，特定检测器和评估条件的泛化性能与语言特征（如时态使用和代词频率）显著相关。这为理解AI文本检测器泛化行为提供了系统性的语言学解释。

Conclusion: 通过系统的语言特征分析，揭示了AI文本检测器泛化性能差异的根本原因，为改进检测器的泛化能力提供了重要见解，表明语言特征偏移是影响跨条件泛化的关键因素。
...
### [98] [Cross-Cultural Expert-Level Art Critique Evaluation with Vision-Language Models](https://arxiv.org/abs/2601.07984)
*Haorui Yu,Ramon Ruiz-Dolz,Xuehang Wen,Fengrui Zhang,Qiufeng Yi*

Main category: cs.CL

TL;DR: 提出三层评估框架用于评估视觉语言模型在跨文化艺术批评中的文化理解能力，发现自动化指标不可靠，西方样本得分更高，跨评委尺度不匹配问题需要校准


<details>
  <summary>Details</summary>
Motivation: 视觉语言模型在视觉感知方面表现出色，但其在艺术中解释文化意义的能力尚未得到充分验证，需要建立系统评估框架来衡量模型对跨文化艺术的文化理解深度

Method: 提出三层评估框架：第一层离线计算自动化覆盖度和风险指标；第二层使用单一主评委基于五个维度进行基于量规的评分；第三层通过等渗回归将第二层聚合分数校准到人类评分，输出校准后的文化理解分数

Result: 在152个样本的保留集上，校准使MAE降低了5.2%；评估了15个VLMs在294个涵盖六种文化传统的专家锚点上；发现自动化指标不能可靠代表文化深度，西方样本得分高于非西方样本，跨评委尺度不匹配使朴素平均不可靠

Conclusion: 该框架为模型选择和文化遗产诊断提供了校准的文化理解分数，强调了需要单一主评委和明确校准来解决跨评委尺度不匹配问题，自动化指标不能替代对文化深度的评估
...
### [99] [Multilingual, Multimodal Pipeline for Creating Authentic and Structured Fact-Checked Claim Dataset](https://arxiv.org/abs/2601.07985)
*Z. Melce Hüsünbeyi,Virginie Mouilleron,Leonie Uhling,Daniel Foppe,Tatjana Scheffler,Djamé Seddah*

Main category: cs.CL

TL;DR: 本文提出了一种构建法语和德语多模态事实核查数据集的新方法，通过聚合ClaimReview信息、抓取完整辟谣文章、标准化裁决结果，并利用大语言模型进行证据提取和理由生成。
...
Method: 开发了全面的数据收集和处理流程：聚合ClaimReview信息流，抓取完整辟谣文章，标准化异构声明裁决，并用结构化元数据和对齐的视觉内容进行丰富。使用最先进的大语言模型和多模态大语言模型进行：(i) 预定义证据类别下的证据提取；(ii) 将证据与裁决联系起来的理由生成。

Result: 通过G-Eval和人工评估表明，该流程能够对不同组织或媒体市场的事实核查实践进行细粒度比较，促进开发更可解释和基于证据的事实核查模型，并为未来多语言、多模态虚假信息验证研究奠定基础。

Conclusion: 该研究为构建多语言、多模态事实核查数据集提供了系统方法，有助于提升事实核查的透明度、可解释性和跨语言适用性，为打击在线虚假信息提供了重要工具和资源基础。
...
### [100] [VULCA-Bench: A Multicultural Vision-Language Benchmark for Evaluating Cultural Understanding](https://arxiv.org/abs/2601.07986)
*Haorui Yu,Ramon Ruiz-Dolz,Diji Yang,Hang He,Fengrui Zhang,Qiufeng Yi*

Main category: cs.CL

TL;DR: VULCA-Bench是一个多文化艺术批评基准，用于评估视觉语言模型在超越表层视觉感知的文化理解能力，包含7,410个图像-批评对，涵盖8种文化传统，采用五层框架评估文化理解深度。


<details>
  <summary>Details</summary>
Motivation: 现有VLM基准主要评估L1-L2能力（物体识别、场景描述、事实问答），而缺乏对高阶文化解释能力的评估。需要开发能够衡量模型文化理解深度的基准。

Method: 创建包含7,410个匹配图像-批评对的多文化数据集，涵盖8种文化传统，支持中英双语。采用五层框架（L1-L5：从视觉感知到哲学美学）操作化文化理解，具体化为225个文化特定维度，并由专家撰写双语批评支持。

Result: 初步结果表明，高层推理（L3-L5）比视觉和技术分析（L1-L2）更具挑战性。数据集、评估脚本和标注工具已在补充材料中以CC BY 4.0许可提供。

Conclusion: VULCA-Bench填补了现有VLM评估在文化理解深度方面的空白，为评估模型超越表层视觉感知的文化解释能力提供了系统框架和资源。
...
### [101] [From Word Sequences to Behavioral Sequences: Adapting Modeling and Evaluation Paradigms for Longitudinal NLP](https://arxiv.org/abs/2601.07988)
...
### [102] [DYCP: Dynamic Context Pruning for Long-Form Dialogue with LLMs](https://arxiv.org/abs/2601.07994)
...
### [103] [Is Sentiment Banana-Shaped? Exploring the Geometry and Portability of Sentiment Concept Vectors](https://arxiv.org/abs/2601.07995)
...
### [104] [Reasoning Beyond Chain-of-Thought: A Latent Computational Mode in Large Language Models](https://arxiv.org/abs/2601.08058)
...
### [105] [Universal computation is intrinsic to language model decoding](https://arxiv.org/abs/2601.08061)
...
### [106] [Calibration Is Not Enough: Evaluating Confidence Estimation Under Language Variations](https://arxiv.org/abs/2601.08064)
...
### [108] [Query Suggestion for Retrieval-Augmented Generation via Dynamic In-Context Learning](https://arxiv.org/abs/2601.08105)
...
### [109] [Debiasing Large Language Models via Adaptive Causal Prompting with Sketch-of-Thought](https://arxiv.org/abs/2601.08108)
...
### [111] [Attention Projection Mixing and Exogenous Anchors](https://arxiv.org/abs/2601.08131)
*Jonathan Su*
...
### [112] [How Reliable are Confidence Estimators for Large Reasoning Models? A Systematic Benchmark on High-Stakes Domains](https://arxiv.org/abs/2601.08134)
...
### [114] [Qalb: Largest State-of-the-Art Urdu Large Language Model for 230M Speakers with Systematic Continued Pre-training](https://arxiv.org/abs/2601.08141)
...
### [115] [Mechanisms are Transferable: Data-Efficient Low-Resource Adaptation via Circuit-Targeted Supervised Fine-Tuning](https://arxiv.org/abs/2601.08146)
...
### [116] [WISE-Flow: Workflow-Induced Structured Experience for Self-Evolving Conversational Service Agents](https://arxiv.org/abs/2601.08158)
...
### [117] [SwiftMem: Fast Agentic Memory via Query-aware Indexing](https://arxiv.org/abs/2601.08160)
...
### [118] [Relational Knowledge Distillation Using Fine-tuned Function Vectors](https://arxiv.org/abs/2601.08169)
...
### [119] [Prompt-Based Clarity Evaluation and Topic Detection in Political Question Answering](https://arxiv.org/abs/2601.08176)
...
### [120] [Triplets Better Than Pairs: Towards Stable and Effective Self-Play Fine-Tuning for LLMs](https://arxiv.org/abs/2601.08198)
...
### [121] [Generation-Augmented Generation: A Plug-and-Play Framework for Private Knowledge Injection in Large Language Models](https://arxiv.org/abs/2601.08209)
...
### [122] [Towards Principled Design of Mixture-of-Experts Language Models under Memory and Inference Constraints](https://arxiv.org/abs/2601.08215)
...
### [123] [User-Oriented Multi-Turn Dialogue Generation with Tool Use at scale](https://arxiv.org/abs/2601.08225)
...
### [124] [Med-CoReasoner: Reducing Language Disparities in Medical Reasoning via Language-Informed Co-Reasoning](https://arxiv.org/abs/2601.08267)
...
### [125] [Discovery and Reinforcement of Tool-Integrated Reasoning Chains via Rollout Trees](https://arxiv.org/abs/2601.08274)
...
### [126] [D$^2$Plan: Dual-Agent Dynamic Global Planning for Complex Retrieval-Augmented Reasoning](https://arxiv.org/abs/2601.08282)
...
### [127] [Enhancing Sentiment Classification and Irony Detection in Large Language Models through Advanced Prompt Engineering Techniques](https://arxiv.org/abs/2601.08302)
...
### [128] [AgriAgent: Contract-Driven Planning and Capability-Aware Tool Orchestration in Real-World Agriculture](https://arxiv.org/abs/2601.08308)
...
### [129] [CLaS-Bench: A Cross-Lingual Alignment and Steering Benchmark](https://arxiv.org/abs/2601.08331)
...
### [130] [Detecting Mental Manipulation in Speech via Synthetic Multi-Speaker Dialogue](https://arxiv.org/abs/2601.08342)
...
### [131] [PATS: Personality-Aware Teaching Strategies with Large Language Model Tutors](https://arxiv.org/abs/2601.08402)
...
### [132] [Silence the Judge: Reinforcement Learning with Self-Verifier via Latent Geometric Clustering](https://arxiv.org/abs/2601.08427)
...
### [133] [Fine-Mem: Fine-Grained Feedback Alignment for Long-Horizon Memory Management](https://arxiv.org/abs/2601.08435)
...
### [134] [JudgeRLVR: Judge First, Generate Second for Efficient Reasoning](https://arxiv.org/abs/2601.08468)
...
### [135] [sui-1: Grounded and Verifiable Long-Form Summarization](https://arxiv.org/abs/2601.08472)
...
### [136] [Do You Understand How I Feel?: Towards Verified Empathy in Therapy Chatbots](https://arxiv.org/abs/2601.08477)
...
### [137] [BenchOverflow: Measuring Overflow in Large Language Models via Plain-Text Prompts](https://arxiv.org/abs/2601.08490)
...
### [138] [It's All About the Confidence: An Unsupervised Approach for Multilingual Historical Entity Linking using Large Language Models](https://arxiv.org/abs/2601.08500)
...
### [139] [STAGE: A Benchmark for Knowledge Graph Construction, Question Answering, and In-Script Role-Playing over Movie Screenplays](https://arxiv.org/abs/2601.08510)
...
### [140] [Algorithmic Stability in Infinite Dimensions: Characterizing Unconditional Convergence in Banach Spaces](https://arxiv.org/abs/2601.08512)
*Przemysław Spyra*
...
### [141] [DeepResearch Bench II: Diagnosing Deep Research Agents via Rubrics from Expert Report](https://arxiv.org/abs/2601.08536)
...
### [142] [Ministral 3](https://arxiv.org/abs/2601.08584)
...
### [143] [ExpSeek: Self-Triggered Experience Seeking for Web Agents](https://arxiv.org/abs/2601.08605)
...
### [144] [GraphSearch: Agentic Search-Augmented Reasoning for Zero-Shot Graph Learning](https://arxiv.org/abs/2601.08621)
...
### [145] [How Order-Sensitive Are LLMs? OrderProbe for Deterministic Structural Reconstruction](https://arxiv.org/abs/2601.08626)
...
### [146] [Get away with less: Need of source side data curation to build parallel corpus for low resource Machine Translation](https://arxiv.org/abs/2601.08629)
...
### [147] [Moral Lenses, Political Coordinates: Towards Ideological Positioning of Morally Conditioned LLMs](https://arxiv.org/abs/2601.08634)
...
### [148] [A Parallel Cross-Lingual Benchmark for Multimodal Idiomaticity Understanding](https://arxiv.org/abs/2601.08645)
...
### [149] [Safe Language Generation in the Limit](https://arxiv.org/abs/2601.08648)
...
### [150] [RULERS: Locked Rubrics and Evidence-Anchored Scoring for Robust LLM Evaluation](https://arxiv.org/abs/2601.08654)
...
### [151] [Analyzing Bias in False Refusal Behavior of Large Language Models for Hate Speech Detoxification](https://arxiv.org/abs/2601.08668)
...
### [152] [Lessons from the Field: An Adaptable Lifecycle Approach to Applied Dialogue Summarization](https://arxiv.org/abs/2601.08682)
...
### [153] [QuantEval: A Benchmark for Financial Quantitative Tasks in Large Language Models](https://arxiv.org/abs/2601.08689)
...
### [154] [Nationality and Region Prediction from Names: A Comparative Study of Neural Models and Large Language Models](https://arxiv.org/abs/2601.08692)
*Keito Inoshita*
...
### [155] [RAGShaper: Eliciting Sophisticated Agentic RAG Skills via Automated Data Synthesis](https://arxiv.org/abs/2601.08699)
...
### [156] [PrivGemo: Privacy-Preserving Dual-Tower Graph Retrieval for Empowering LLM Reasoning with Memory Augmentation](https://arxiv.org/abs/2601.08739)
...
### [157] [From Rows to Reasoning: A Retrieval-Augmented Multimodal Framework for Spreadsheet Understanding](https://arxiv.org/abs/2601.08741)
...
### [158] [Inferring Latent Intentions: Attributional Natural Language Inference in LLM Agents](https://arxiv.org/abs/2601.08742)
...
### [159] [TableCache: Primary Foreign Key Guided KV Cache Precomputation for Low Latency Text-to-SQL](https://arxiv.org/abs/2601.08743)
...
### [160] [To Retrieve or To Think? An Agentic Approach for Context Evolution](https://arxiv.org/abs/2601.08747)
...
### [161] [Spatial Context Improves the Integration of Text with Remote Sensing for Mapping Environmental Variables](https://arxiv.org/abs/2601.08750)
...
### [162] [Multiplex Thinking: Reasoning via Token-wise Branch-and-Merge](https://arxiv.org/abs/2601.08808)
...
### [163] [Modeling LLM Agent Reviewer Dynamics in Elo-Ranked Review System](https://arxiv.org/abs/2601.08829)
...
### [164] [Bridging the Trust Gap: Clinician-Validated Hybrid Explainable AI for Maternal Health Risk Assessment in Bangladesh](https://arxiv.org/abs/2601.07866)
*Farjana Yesmin,Nusrat Shirmin,Suraiya Shabnam Bristy*

Main category: cs.AI

TL;DR: 该研究提出了一个结合模糊逻辑和SHAP解释的混合可解释AI框架，用于孕产妇健康风险预测，在孟加拉国临床验证中获得了医疗专业人员的信任和偏好。


<details>
  <summary>Details</summary>
Motivation: 在资源有限的环境中，机器学习用于孕产妇健康风险预测面临关键障碍：缺乏可解释性和临床信任，阻碍了临床采用。

Method: 开发了模糊-XGBoost混合模型，结合前向模糊逻辑和后向SHAP解释，在1,014份孕产妇健康记录上训练，并通过14名孟加拉国医疗专业人员的系统性反馈进行验证。

Result: 模型达到88.67%准确率（ROC-AUC: 0.9703）；71.4%的临床医生偏好混合解释，54.8%表示信任可用于临床；SHAP分析显示医疗可及性是主要预测因子，模糊风险评分排名第三验证了临床知识整合。

Conclusion: 结合可解释模糊规则和特征重要性解释的混合XAI框架能增强孕产妇健康风险预测的实用性和临床信任，为资源有限环境中的AI部署提供了实践指导。
...
### [165] [When Models Know When They Do Not Know: Calibration, Cascading, and Cleaning](https://arxiv.org/abs/2601.07965)
*Chenjie Hao,Weyl Lu,Yuko Ishiwaka,Zengyi Li,Weier Wan,Yubei Chen*

Main category: cs.AI

TL;DR: 提出了一种无需训练、通用的模型校准方法，通过置信度让模型识别自身未知情况，并应用于模型级联和数据清洗，提升AI效率与可靠性。


<details>
  <summary>Details</summary>
Motivation: 当模型能够识别自身未知时，会开启许多可能性。核心问题是如何让模型知道自己不知道什么。现有研究表明校准可以提供可靠的置信度估计，但需要一种简单有效且通用的方法。

Method: 提出无需训练的通用校准方法，适用于视觉和语言模型。基于两个关键观察：1) 单一模型内置信度越高准确率越高；2) 在验证集上校准的模型在测试集上仍保持校准。应用包括：1) 基于校准优势路由的模型级联；2) 基于模型集成的数据清洗方法。

Result: 校准置信度具有可靠性和可比性。模型级联能在几乎不损失准确率的情况下提升效率，两个规模相当的模型级联能超越任一单独模型性能。数据清洗方法在ImageNet和MMLU数据集上能有效识别错误标注样本，平衡精确度和检测率。

Conclusion: 让模型识别自身未知是实现更高效、可靠、可信AI的实用步骤。提出的校准方法简单有效，为模型级联和数据清洗等应用提供了基础。
...
### [166] [Reasoning over Precedents Alongside Statutes: Case-Augmented Deliberative Alignment for LLM Safety](https://arxiv.org/abs/2601.08000)
...
<details>
  <summary>Details</summary>
Motivation: 现有方法中，详细的安全规则指定在开源LLM中效果不一致，会降低帮助性，需要一种既能提升安全性又不损害实用性的方法

Method: 提出CADA方法，使用案例增强的简单代码而非详细规则，通过强化学习在自生成的安全推理链上进行训练

Result: CADA有效提升了无害性，增强了对抗攻击的鲁棒性，减少了过度拒绝，同时在多样化基准测试中保持了实用性

Conclusion: 案例增强的审议对齐为提升LLM安全性提供了实用替代方案，避免了规则导向方法的局限性，实现了安全性与帮助性的更好平衡
...
### [167] [Internal Deployment Gaps in AI Regulation](https://arxiv.org/abs/2601.08005)
...
<details>
  <summary>Details</summary>
Motivation: 前沿AI监管主要关注面向外部用户的系统部署，但企业内部部署的高风险AI系统（如自动化研发、关键业务流程处理、敏感数据处理）同样重要。目前法规在内部部署方面的监管存在漏洞，可能导致这些高风险应用逃避应有的监管。

Method: 论文通过分析美国和欧盟2025年的前沿AI法规，识别内部部署系统的监管缺口。研究采用法规文本分析、监管框架评估和系统性漏洞识别的方法，从监管范围、合规评估机制和信息不对称三个维度进行分析。

Result: 识别出三个关键监管缺口：1) 监管范围模糊性允许内部系统逃避监管义务；2) 一次性合规评估无法捕捉内部系统的持续演化；3) 信息不对称削弱监管机构的意识和监督能力。这些缺口源于可测量性、激励机制和信息获取等方面的内在矛盾。

Conclusion: 论文呼吁政策制定者需要有针对性地解决内部部署AI系统的监管漏洞，而不是偶然性地处理。通过理解这些监管模式，可以更审慎地制定相关政策，平衡创新需求与风险管理，确保前沿AI系统在内部部署时也能得到适当的监管。
...
### [168] [Integrating Attendance Tracking and Emotion Detection for Enhanced Student Engagement in Smart Classrooms](https://arxiv.org/abs/2601.08049)
...
<details>
  <summary>Details</summary>
Motivation: 当前高校智能教室技术主要关注自动化考勤，对学生课堂情绪和认知参与度关注不足，限制了教师识别学生参与度并实时调整教学策略的能力

Method: 基于物联网的系统，使用树莓派摄像头和OpenCV进行人脸检测，采用微调的MobileNetV2模型分类四种学习相关情绪状态（投入、无聊、困惑、沮丧），实现基于会话的考勤管理和连续情绪分析

Result: 使用DAiSEE数据集进行实验评估，情绪分类准确率达到89.5%。考勤数据与情绪分析的结合能为教师提供更深入的课堂动态洞察

Conclusion: 整合考勤与情绪分析的系统能够为教师提供额外的课堂动态洞察，支持更及时响应的教学实践，提升课堂参与度监控能力
...
### [169] [Forecast Aware Deep Reinforcement Learning for Efficient Electricity Load Scheduling in Dairy Farms](https://arxiv.org/abs/2601.08052)
...
### [170] [A New Strategy for Verifying Reach-Avoid Specifications in Neural Feedback Systems](https://arxiv.org/abs/2601.08065)
...
### [171] [Semantic Gravity Wells: Why Negative Constraints Backfire](https://arxiv.org/abs/2601.08070)
*Shailesh Rana*
...
### [172] [MemoBrain: Executive Memory as an Agentic Brain for Reasoning](https://arxiv.org/abs/2601.08079)
...
### [173] [MirrorBench: An Extensible Framework to Evaluate User-Proxy Agents for Human-Likeness](https://arxiv.org/abs/2601.08118)
...
### [174] [How vehicles change lanes after encountering crashes: Empirical analysis and modeling](https://arxiv.org/abs/2601.08125)
...
### [175] [Embedded AI Companion System on Edge Devices](https://arxiv.org/abs/2601.08128)
...
### [176] [Project Synapse: A Hierarchical Multi-Agent Framework with Hybrid Memory for Autonomous Resolution of Last-Mile Delivery Disruptions](https://arxiv.org/abs/2601.08156)
...
### [177] [ZeroDVFS: Zero-Shot LLM-Guided Core and Frequency Allocation for Embedded Platforms](https://arxiv.org/abs/2601.08166)
...
### [178] [The Agent's First Day: Benchmarking Learning, Exploration, and Scheduling in the Workplace Scenarios](https://arxiv.org/abs/2601.08173)
...
### [179] [Improving LLM Reasoning with Homophily-aware Structural and Semantic Text-Attributed Graph Compression](https://arxiv.org/abs/2601.08187)
...
### [180] [Adapting Rules of Official International Mahjong for Online Players](https://arxiv.org/abs/2601.08211)
...
### [181] [WebTrap Park: An Automated Platform for Systematic Security Evaluation of Web Agents](https://arxiv.org/abs/2601.08406)
...
### [182] [An Axiomatic Approach to General Intelligence: SANC(E3) -- Self-organizing Active Network of Concepts with Energy E3](https://arxiv.org/abs/2601.08224)
...
### [183] [MPCI-Bench: A Benchmark for Multimodal Pairwise Contextual Integrity Evaluation of Language Model Agents](https://arxiv.org/abs/2601.08235)
...
### [184] [The End of Reward Engineering: How LLMs Are Redefining Multi-Agent Coordination](https://arxiv.org/abs/2601.08237)
...
### [185] [Large Artificial Intelligence Model Guided Deep Reinforcement Learning for Resource Allocation in Non Terrestrial Networks](https://arxiv.org/abs/2601.08254)
...
### [186] [T3: Benchmarking Sycophancy and Skepticism in Causal Judgment](https://arxiv.org/abs/2601.08258)
*Edward Y. Chang*
...
### [187] [VGG Induced Deep Hand Sign Language Detection](https://arxiv.org/abs/2601.08262)
...
### [188] [Sparsity Is Necessary: Polynomial-Time Stability for Agentic LLMs in Large Action Spaces](https://arxiv.org/abs/2601.08271)
*Angshul Majumdar*
...
### [189] [ToolACE-MCP: Generalizing History-Aware Routing from MCP Tools to the Agent Web](https://arxiv.org/abs/2601.08276)
...
### [190] [Greedy Is Enough: Sparse Action Discovery in Agentic LLMs](https://arxiv.org/abs/2601.08280)
*Angshul Majumdar*
...
### [191] [OpenMic: A Multi-Agent-Based Stand-Up Comedy Generation System](https://arxiv.org/abs/2601.08288)
...
### [192] [AtomMem : Learnable Dynamic Agentic Memory with Atomic Memory Operation](https://arxiv.org/abs/2601.08323)
...
### [193] [Semantic Laundering in AI Agent Architectures: Why Tool Boundaries Do Not Confer Epistemic Warrant](https://arxiv.org/abs/2601.08333)
...
### [194] [Thematic Working Group 5 -- Artificial Intelligence (AI) literacy for teaching and learning: design and implementation](https://arxiv.org/abs/2601.08380)
...
### [195] [A Qualitative Model to Reason about Object Rotations (QOR) applied to solve the Cube Comparison Test (CCT)](https://arxiv.org/abs/2601.08382)
*Zoe Falomir*
...
### [197] [Creativity in AI as Emergence from Domain-Limited Generative Models](https://arxiv.org/abs/2601.08388)
*Corina Chutaux*
...
### [198] [Owen-Shapley Policy Optimization (OSPO): A Principled RL Algorithm for Generative Search LLMs](https://arxiv.org/abs/2601.08403)
...
### [199] [Hybrid Distillation with CoT Guidance for Edge-Drone Control Code Generation](https://arxiv.org/abs/2601.08412)
...
### [200] [RubricHub: A Comprehensive and Highly Discriminative Rubric Dataset via Automated Coarse-to-Fine Generation](https://arxiv.org/abs/2601.08430)
...
### [201] [YaPO: Learnable Sparse Activation Steering Vectors for Domain Adaptation](https://arxiv.org/abs/2601.08441)
...
### [202] [Beyond Linearization: Attributed Table Graphs for Table Reasoning](https://arxiv.org/abs/2601.08444)
...
### [203] [An Under-Explored Application for Explainable Multimodal Misogyny Detection in code-mixed Hindi-English](https://arxiv.org/abs/2601.08457)
...
### [204] [SUMMPILOT: Bridging Efficiency and Customization for Interactive Summarization System](https://arxiv.org/abs/2601.08475)
...
### [205] [What If TSF: A Benchmark for Reframing Forecasting as Scenario-Guided Multimodal Forecasting](https://arxiv.org/abs/2601.08509)
...
### [206] [Sketch-Based Facade Renovation With Generative AI: A Streamlined Framework for Bypassing As-Built Modelling in Industrial Adaptive Reuse](https://arxiv.org/abs/2601.08531)
...
### [207] [Learner-Tailored Program Repair: A Solution Generator with Iterative Edit-Driven Retrieval Enhancement](https://arxiv.org/abs/2601.08545)
...
### [208] [WaterCopilot: An AI-Driven Virtual Assistant for Water Management](https://arxiv.org/abs/2601.08559)
...
### [209] [ViDoRe V3: A Comprehensive Evaluation of Retrieval Augmented Generation in Complex Real-World Scenarios](https://arxiv.org/abs/2601.08620)
...
### [210] [Resisting Manipulative Bots in Memecoin Copy Trading: A Multi-Agent Approach with Chain-of-Thought Reasoning](https://arxiv.org/abs/2601.08641)
...
### [211] [Prism: Towards Lowering User Cognitive Load in LLMs via Complex Intent Understanding](https://arxiv.org/abs/2601.08653)
...
### [215] [Advancing ESG Intelligence: An Expert-level Agent and Comprehensive Benchmark for Sustainable Finance](https://arxiv.org/abs/2601.08676)
...
### [216] [PersonaDual: Balancing Personalization and Objectivity via Adaptive Reasoning](https://arxiv.org/abs/2601.08679)
...
### [217] [MEMEWEAVER: Inter-Meme Graph Reasoning for Sexism and Misogyny Detection](https://arxiv.org/abs/2601.08684)
...
### [218] [All Required, In Order: Phase-Level Evaluation for AI-Human Dialogue in Healthcare and Beyond](https://arxiv.org/abs/2601.08690)
...
### [219] [Evaluating the Ability of Explanations to Disambiguate Models in a Rashomon Set](https://arxiv.org/abs/2601.08703)
...
### [220] [Learning from Demonstrations via Capability-Aware Goal Sampling](https://arxiv.org/abs/2601.08731)
...
### [221] [AI as Entertainment](https://arxiv.org/abs/2601.08768)
...
### [222] [Pervasive Annotation Errors Break Text-to-SQL Benchmarks and Leaderboards](https://arxiv.org/abs/2601.08778)
...
### [223] [Uncovering Political Bias in Large Language Models using Parliamentary Voting Records](https://arxiv.org/abs/2601.08785)
...
### [224] [Post-Quantum Cryptography Key Expansion Method and Anonymous Certificate Scheme Based on NTRU](https://arxiv.org/abs/2601.07841)
*Abel C. H. Chen*
...
Method: 提出基于NTRU的密钥扩展方法，允许从单个密钥对扩展出多个不同的公钥。将该方法应用于匿名证书方案，使终端实体只需生成一次密钥对，证书机构即可为其扩展多个不同的公钥以实现匿名性。

Result: 实验结果表明，所提出的密钥扩展方法相比密钥对生成具有显著更高的效率。

Conclusion: 该研究解决了NTRU密钥生成效率低的问题，通过密钥扩展方法提升了性能，并成功应用于匿名证书方案，为后量子密码学的实际应用提供了更高效的解决方案。
...
### [225] [FinVault: Benchmarking Financial Agent Safety in Execution-Grounded Environments](https://arxiv.org/abs/2601.07853)
...
TL;DR: FinVault是首个面向金融智能体的执行基础安全基准，包含31个监管案例驱动的沙盒场景、107个真实漏洞和963个测试用例，揭示现有防御机制在真实金融环境中效果有限，攻击成功率仍高达50%


<details>
  <summary>Details</summary>
Motivation: 当前基于大语言模型的金融智能体在投资分析、风险评估和自动决策中广泛应用，其规划、工具调用和状态操作能力在高风险、强监管的金融环境中引入了新的安全风险。然而，现有安全评估主要关注语言模型层面的内容合规性或抽象智能体设置，未能捕捉真实操作流程和状态改变行为带来的执行基础风险。

Method: 提出FinVault基准，包含31个监管案例驱动的沙盒场景，配备可写状态数据库和明确的合规约束，包含107个真实世界漏洞和963个测试用例，系统覆盖提示注入、越狱攻击、金融适配攻击以及用于误报评估的良性输入。

Result: 实验结果显示，现有防御机制在真实金融智能体设置中仍然无效，最先进模型的平均攻击成功率仍高达50.0%，即使对于最鲁棒的系统，攻击成功率仍达6.7%（不可忽视），突显当前安全设计的有限可迁移性和对更强金融特定防御的需求。

Conclusion: FinVault填补了金融智能体安全评估的空白，揭示了现有安全机制在真实金融环境中的局限性，强调了开发更强金融特定防御的必要性，为金融智能体安全研究提供了重要基准。
...
### [226] [ForgetMark: Stealthy Fingerprint Embedding via Targeted Unlearning in Language Models](https://arxiv.org/abs/2601.08189)
*Zhenhua Xu,Haobo Zhang,Zhebo Wang,Qichen Liu,Haitao Xu,Wenpeng Xing,Meng Han*

Main category: cs.CR

TL;DR: ForgetMark是一种隐蔽的模型指纹框架，通过目标性遗忘编码模型来源，避免传统后门指纹的高困惑度触发器和固定响应模式，实现100%所有权验证同时保持标准性能。


<details>
  <summary>Details</summary>
Motivation: 现有后门指纹存在高困惑度触发器易被过滤、固定响应模式易被启发式检测器发现、以及在良性输入上产生虚假激活等问题，需要更隐蔽、鲁棒的模型所有权验证方法。

Method: 构建紧凑的人类可读键值对集合，使用辅助模型和预测熵排序，训练轻量级LoRA适配器在保持通用能力的同时抑制原始值对键的响应，通过聚合似然和语义证据进行所有权验证。

Result: 在不同架构和设置下实现100%所有权验证，保持标准性能，在隐蔽性和模型合并鲁棒性方面超越后门基线，在适度增量微调下仍保持有效。

Conclusion: ForgetMark通过依赖概率性遗忘痕迹而非固定触发-响应模式，避免了高困惑度触发器，降低了可检测性和误触发，为模型所有权验证提供了更隐蔽、鲁棒的解决方案。
...
### [227] [DNF: Dual-Layer Nested Fingerprinting for Large Language Model Intellectual Property Protection](https://arxiv.org/abs/2601.08223)
...
### [228] [A Survey of Security Challenges and Solutions for UAS Traffic Management (UTM) and small Unmanned Aerial Systems (sUAS)](https://arxiv.org/abs/2601.08229)
...
### [229] [APT-MCL: An Adaptive APT Detection System Based on Multi-View Collaborative Provenance Graph Learning](https://arxiv.org/abs/2601.08328)
...
### [230] [On the Maximum Toroidal Distance Code for Lattice-Based Public-Key Cryptography](https://arxiv.org/abs/2601.08452)
...
### [231] [Baiting AI: Deceptive Adversary Against AI-Protected Industrial Infrastructures](https://arxiv.org/abs/2601.08481)
...
### [232] [MASH: Evading Black-Box AI-Generated Text Detectors via Style Humanization](https://arxiv.org/abs/2601.08564)
...
### [233] [Estimating the True Distribution of Data Collected with Randomized Response](https://arxiv.org/abs/2601.08603)
...
### [234] [Double Strike: Breaking Approximation-Based Side-Channel Countermeasures for DNNs](https://arxiv.org/abs/2601.08698)
...
### [235] [Malware Detection based on API Calls: A Reproducibility Study](https://arxiv.org/abs/2601.08725)
*Juhani Merilehto*
...
### [236] [Memory DisOrder: Memory Re-orderings as a Timerless Side-channel](https://arxiv.org/abs/2601.08770)
...
### [237] [Emergent Coordination in Multi-Agent Systems via Pressure Fields and Temporal Decay](https://arxiv.org/abs/2601.08129)
*Roland Rodriguez*

Main category: cs.MA

TL;DR: 本文提出了一种基于压力场协调的新型多智能体LLM框架，通过共享压力梯度实现隐式协调，性能与显式分层控制相当，但显著优于对话式协调方法。


<details>
  <summary>Details</summary>
Motivation: 当前多智能体LLM框架依赖显式编排模式（如规划者-执行者、管理者-工作者等层级结构），存在协调开销随智能体数量和任务复杂度增加而急剧增长的问题。受自然协调机制启发，需要寻找更简单有效的协调基础。

Method: 提出压力场协调范式：智能体在共享工件上局部操作，仅受可测量质量信号导出的压力梯度引导，通过时间衰减防止过早收敛。形式化为压力景观上的优化，并在温和条件下证明收敛保证。

Result: 在拉丁方约束满足问题的1078次试验中，压力场协调与分层控制性能相当（38.2% vs 38.8%解决率，p=0.94）。两者均显著优于顺序（23.3%）、随机（11.7%）和基于对话的多智能体协调（8.6%，p<0.00001）。时间衰减至关重要：禁用后最终压力增加49倍。在简单问题上达到87%解决率，性能在2-32个智能体间保持一致。

Conclusion: 通过共享压力梯度的隐式协调能够达到与显式分层控制相当的效果，同时显著优于显式对话式协调。这表明约束驱动的涌现为多智能体AI提供了更简单、同样有效的基础。
...
### [238] [Agent Contracts: A Formal Framework for Resource-Bounded Autonomous AI Systems](https://arxiv.org/abs/2601.08815)
*Qing Ye,Jing Tan*

Main category: cs.MA

TL;DR: Agent Contracts框架将合同协议从任务分配扩展到资源受限执行，为多智能体系统提供正式的资源治理机制，实现可预测、可审计的自主AI部署。


<details>
  <summary>Details</summary>
Motivation: 现有现代智能体协议虽然标准化了连接性和互操作性，但缺乏正式的、基于资源治理规范的机制来限制智能体的资源消耗和运行时间，需要建立可预测的资源边界。

Method: 提出Agent Contracts框架，统一输入/输出规范、多维资源约束、时间边界和成功标准，建立具有明确生命周期语义的治理机制，并通过守恒定律确保委托预算尊重父级约束。

Result: 四个实验验证：迭代工作流中实现90%的token减少和525倍更低的方差；多智能体委托中零守恒违规；通过合同模式实现可测量的质量-资源权衡。

Conclusion: Agent Contracts为可预测、可审计和资源受限的自主AI部署提供了正式基础，扩展了合同协议在智能体系统中的适用范围。
